...
## Re-Writing the consumers.py

- In order for our chat application to make use of the channels_layer in the settings.py we have to re-write the code in our consumers.py and the code goes as follows;
...
## Re-Writing the Consumer to async

- In this section we are basically rewriting the consumer the code goes as follows;
